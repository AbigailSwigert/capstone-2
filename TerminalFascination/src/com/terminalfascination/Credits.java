...
abstract class Credits {
    ...
    public static void printGameCredits() {
        MapArea.clearScreen();
        System.out.println(Character.RESET + "-------------Terminal Fascination Credits-------------");
        System.out.println("Writer and Developer: Abigail Swigert");
        ...
        System.out.println(NonPlayerCharacter.PRINCESS_JESSICA.textColor + "Princess Jessica The Human:    Jessica Ulysse");
    }
}
