        ...
        inputLoop: while (true) {
            ...
            switch (playerReply) {
                ...
                case 1:
                    ...
                    System.out.println("\nUnfortunately no one even heard that Clit Eastwood worthy line, as the " + Species.KRYSY.speciesName + " began screaming and climbing up each other to get out of the room as soon as the chainsaw started up. The good news is, you and Crition are safe, and you didn't even have to use your ridiculous weapon. The bad news is, the room is full of wounded guards all staring at you.");
                    break inputLoop;
                case 2:
